        ...
        Obx(() => controller.selectedProviderId.value == null 
          ...
          : Column(
            children: [
                  ...
                  Expanded(
                    ...
                    child: Column(
                      children: [
                        Row(
                          children: [
                            Expanded(child: CustomTextField(label: "First Name *", controller: controller.firstNameCtrl, enabled: !controller.isViewOnly.value)),
                            const SizedBox(width: 16),
                            Expanded(child: CustomTextField(label: "Last Name *", controller: controller.lastNameCtrl, enabled: !controller.isViewOnly.value)),
                          ],
                        ),
                        const SizedBox(height: 16),
                        CustomTextField(label: "Middle Name", controller: controller.middleNameCtrl, enabled: !controller.isViewOnly.value),
                        const SizedBox(height: 16),
              ...
              Row(
                children: [
                  Expanded(child: CustomTextField(label: "Email Address", controller: controller.emailCtrl, enabled: !controller.isViewOnly.value)),
                  const SizedBox(width: 16),
                  Expanded(child: CustomTextField(label: "Aadhar Number *", controller: controller.aadharCtrl, enabled: !controller.isViewOnly.value)),
                ],
              ),
              const SizedBox(height: 16),
              AbsorbPointer(
                absorbing: controller.isViewOnly.value,
                child: CustomDropdown(label: "Gender *", items: const ["Male", "Female", "Other"], selectedValue: controller.selectedGender),
              ),
            ],
          )
        ),
