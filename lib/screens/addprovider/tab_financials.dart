  ...
  Widget _buildEditForm(dynamic bankingCtrl) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Expanded(child: CustomTextField(label: "Account Holder", controller: controller.accHolderCtrl)),
        ...
        Obx(() {
          ...
          return Column(
            ...
            children: [
              const SizedBox(height: 8),
              CustomTextField(label: "PAN Number", controller: controller.panNumberCtrl),
              const SizedBox(height: 16),
